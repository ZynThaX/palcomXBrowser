...
public class DNDTabbedPane extends JTabbedPane {
	...
	private TabTransferData getTabTransferData(DropTargetDropEvent a_event) {		
		try {
			TabTransferData data = (TabTransferData) a_event.getTransferable().getTransferData(TabTransferable.FLAVOR);				
			return data;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private TabTransferData getTabTransferData(DragSourceDragEvent a_event) {
		try {
			TabTransferData data = (TabTransferData) a_event.getDragSourceContext().getTransferable().getTransferData(TabTransferable.FLAVOR);				
			return data;
		} catch (Exception e) {
			e.printStackTrace();
		}
